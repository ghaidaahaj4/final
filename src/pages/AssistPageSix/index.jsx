...
import AiassistpagesixRowThree from "./AssistSixRowSix";
import React from "react";

export default function AIASSISTPageSixPage() {
    return (
        <>
            <Helmet>
            ...
            <div className="w-full bg-white-a700">
                <div>
                    <header className="relative z-[1] flex items-end justify-center bg-white-a700 py-[26px] sm:py-5">
                        <div className="container-s mt-1 flex items-start justify-between gap-5 md:flex-col md:px-5">
