...
import AiassistpagefourRowFour from "./AssistPageFourRowTwo";
import React from "react";

export default function AIASSISTPageFourPage() {
    return (
        <>
            <Helmet>
                <title>GiftFlow's Application3</title>
            ...
            <div className="w-full bg-white-a700">
                <div>
                    ...
                    <div className="relative mt-[-8px] h-[886px] bg-[url('/public/images/img_group_15.png')] bg-cover bg-no-repeat md:h-auto">
                        <AiassistpagefourRowFour />
                    </div>
                </div>
            </div>
        </>
